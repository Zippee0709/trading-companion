  ...
  return (
    <footer className="border-t py-8">
      <div className="mx-auto flex w-full max-w-screen-xl flex-col px-4">
        <div className="flex w-full max-w-screen-xl flex-col items-start gap-8 lg:flex-row lg:justify-between">
        ...
        <hr className="my-6 w-full max-w-screen-xl border-gray-100 dark:border-gray-700 lg:my-8" />
        <div className="flex w-full max-w-screen-xl flex-col gap-4 lg:flex-row lg:justify-between">
